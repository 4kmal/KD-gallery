...
const LoaderCard: React.FC<LoaderCardProps> = ({ title, code, techStack, author, children }) => {
...
<div class="spinner-box">
  ...
  return (
    <>
      <style>{styles}</style>
      <LoaderCard title="SOLAR_SYSTEM" techStack="HTML / CSS" author={MOCK_USERS.jinbei} code={solarCode}>
      ...
      <LoaderCard title="SQUARE_LOADER" techStack="HTML / CSS" author={MOCK_USERS.kiyoraka} code={squaresCode}>
